...
[![GoDoc](https://godoc.org/github.com/stevebargelt/mygobot?status.svg)](https://godoc.org/github.com/stevebargelt/mygobot)
...
Get the Gobot package by running this command: `go get -d -u github.com/stevebargelt/mygobot`
...
To activate the API, import the `github.com/stevebargelt/mygobot/api` package and instantiate the `API` like this:
